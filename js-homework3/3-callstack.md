...
function a_word(_1, _2, _3, _4) { 
  ...
  var word = tour(_2, _4, _1, _3/* fill this in */);

  var result = word;
  return result;
}
const return_val = a_word("t", "o", "u", "r" /* fill this in */);
console.assert(return_val === 'tour', "wu-2: return_val === " + return_val);
```
